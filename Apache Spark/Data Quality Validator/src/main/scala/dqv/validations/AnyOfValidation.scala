...
final case class AnyOfValidation(
  ...
  override def report(implicit observer: Observer): String = {
    ...
    s"""
      $emoji isAnyOf($attr, ${domain.mkString("(", ", ", ")")}): total of $metricValue dirty records found!
    """
  }
}
